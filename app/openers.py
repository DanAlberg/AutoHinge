...
def run_llm4_long(openers_json: Dict[str, Any], critiques_json: Dict[str, Any], extracted: Dict[str, Any], model: str | None = None) -> Dict[str, Any]:
    """Run LLM4 for long-term relationship openers with critique feedback."""
    prompt = LLM4_LONG(openers_json, critiques_json, extracted)
    return _run_llm4_prompt(prompt, call_id="llm4_long", model=model)


def run_llm4_short(openers_json: Dict[str, Any], critiques_json: Dict[str, Any], extracted: Dict[str, Any], model: str | None = None) -> Dict[str, Any]:
    """Run LLM4 for short-term relationship openers with critique feedback."""
    prompt = LLM4_SHORT(openers_json, critiques_json, extracted)
    return _run_llm4_prompt(prompt, call_id="llm4_short", model=model)
