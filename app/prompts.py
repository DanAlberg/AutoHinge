...
BANNED_WORDS = ["trouble", "mischief", "chaos", "ruin my life", "danger", "dangerous", "main character", "elite", "mob wife", "vibe", "heist", "paparazzi", "apres ski, iconic", "actually X or just Y"]
...
def LLM3_LONG(extracted: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "- Do use question marks. Don't use full stops. Use proper capitalisation where required\n\n"
        "- DO NOT suggest sit-down dinners, restaurants, or formal dates. DO NOT suggest drinks if her profile explicitly indicates she does not drink."
...
def LLM3_5_CRITIQUE(openers_json: Dict[str, Any], extracted: Dict[str, Any], variant: str) -> str:
    ...
    return (
        ...
        "- Does he suggest a sit-down dinner, restaurant, or expensive date? (This is an immediate 'ick' and must be marked as Discard)."
        "Rules:\n"
...
def LLM4_5_CRITIQUE(llm4_result: Dict[str, Any], extracted: Dict[str, Any], variant: str) -> str:
    ...
    return (
        ...
        "- Does it suggest a sit-down dinner, restaurant, or formal date? (If yes, you MUST reject it)."
        "Rules:\n"
        "- Output JSON only, no emojis, no em dashes.\n"
